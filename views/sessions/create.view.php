    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="/sessions" method="POST">
        <div>
          <div class="flex items-center justify-between">
            ...
            <?php if (isset($errors['email'])) : ?>
              <div class="text-sm">
                <p class="font-semibold text-red-600 "><?= $errors['email'] ?></p>
              </div>
            <?php endif; ?>
          </div>
          <div class="mt-2">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <?php if (isset($errors['password'])) : ?>
              <div class="text-sm">
                <p class="font-semibold text-red-600 "><?= $errors['password'] ?></p>
              </div>
            <?php endif; ?>
          </div>
          <div class="mt-2">
        ...
        <?php if (isset($errors['message'])) : ?>
          <div>
            <p class="text-red-500 text-center"><?= $errors['message'] ?></p>
          </div>
        <?php endif; ?>
        <div>
